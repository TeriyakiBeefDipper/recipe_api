...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def _get_or_create_tags(self, tags, recipe):
        ...
        for tag in tags:  # noqa this is moved form create method, and we edit create method to be simpler
    ...
    def _get_or_create_ingredients(self, ingredients, recipe):
        ...
        for ingredient in ingredients:
            ingredient_obj, create = Ingredient.objects.get_or_create(user=auth_user, **ingredient)  # noqa
